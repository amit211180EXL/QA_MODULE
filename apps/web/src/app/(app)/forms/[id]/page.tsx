        ...
        <div className="flex items-start justify-between gap-4 bg-gradient-to-r from-slate-50 to-white px-5 py-4">
          <div>
            <h1 className="text-lg font-bold text-slate-900">
              {form.name}
              <span className="ml-2 rounded-md bg-slate-100 px-2 py-0.5 text-sm font-semibold text-slate-400">
                v{form.version}
              </span>
            </h1>
            <p className="mt-0.5 font-mono text-xs text-slate-400">{form.formKey}</p>
          </div>
