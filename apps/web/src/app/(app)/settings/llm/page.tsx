...
export default function LlmSettingsPage() {
  ...
  return (
    <>
        ...
        <CardBody>
          {isLoading ? (
            ...
            >
              {/* Provider */}
              <div>
                <label className="mb-2 block text-sm font-semibold text-slate-900">Provider</label>
                <select
              ...
              {/* Feedback */}
              {saveMutation.isSuccess && <Alert variant="success">Configuration saved successfully.</Alert>}
      ...
      {/* Info box */}
      <Card shadow="xs" className="overflow-hidden border-primary-200/60 bg-gradient-to-r from-primary-50/90 to-white">
