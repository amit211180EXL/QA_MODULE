...
export default function BlindReviewPage() {
  ...
  const { register, handleSubmit, reset, formState: { isDirty } } = useForm<BlindReviewValues>({
              ...
              <label className="flex items-start gap-4 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    ...
                    <span className="font-mono text-xs bg-slate-100 px-1 py-0.5 rounded">Agent #a3f7</span>) instead of the real
                    agent name and ID, reducing recency or familiarity bias.
                  </p>
                </div>
              </label>
