...
const schema = z.object({
  qaDeviationThreshold: z.number({ invalid_type_error: 'Must be a number' }).min(0).max(100),
  verifierDeviationThreshold: z.number({ invalid_type_error: 'Must be a number' }).min(0).max(100),
  staleQueueHours: z.number({ invalid_type_error: 'Must be a number' }).int().min(1),
});
                ...
                <div>
                  ...
                  {errors.qaDeviationThreshold && (
                    <p className="mt-2 text-sm text-danger-600">
                      {errors.qaDeviationThreshold.message}
                    </p>
                  )}
                </div>
